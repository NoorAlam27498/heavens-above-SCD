...
const eventsIridium = [
  ...
  "date", "time", "distanceToSatellite",
  "AngleOffFlareCentre-line", "flareProducingAntenna",
  "sunAltitude", "angularSeparationFromSun", "image", "id"
];
  ...
  request(options, (error, response, body) => {
    ...
    tbody.find("tr").each((i, o) => {
      ...
      temp.url =
        ...
        $(o).find("td").eq(0).find("a").attr("href").replace("type=V", "type=A");
      queue.push(temp);
    });
